...
public class TrangChuNguoiDung_Activity extends AppCompatActivity {
    GridView grv2;
    GridView grv1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trangchu_nguoi_dung);
        ...
        if (tendn != null) {
            ...
            Intent intent = new Intent(TrangChuNguoiDung_Activity.this, Login_Activity.class);
        ...
        grv2.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (nhomSanPham != null) {
                ...
                Intent intent = new Intent(TrangChuNguoiDung_Activity.this, DanhMucSanPham_Activity.class);
        ...
        btntrangchu.setOnClickListener(view -> {
            Intent intent = new Intent(TrangChuNguoiDung_Activity.this, DonHangUser_Activity.class);
        ...
        btntimkiem.setOnClickListener(view -> {
            Intent intent = new Intent(TrangChuNguoiDung_Activity.this, TimKiemSanPham_Activity.class);
        ...
        btncart.setOnClickListener(view -> {
            Intent intent = new Intent(TrangChuNguoiDung_Activity.this, GioHang_Activity.class);
            intent.putExtra("tendn", tendn); // Gửi tên đăng nhập
            startActivity(intent);
        });
        btncanhan.setOnClickListener(view -> {
            Intent intent = new Intent(TrangChuNguoiDung_Activity.this, TrangCaNhanNguoiDung_Activity.class);
            intent.putExtra("tendn", tendn); // Gửi tên đăng nhập
            startActivity(intent);
        });
        // Các sự kiện khác
