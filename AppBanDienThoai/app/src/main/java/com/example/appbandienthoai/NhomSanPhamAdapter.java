...
public class NhomSanPhamAdapter extends BaseAdapter {
    ...
    private void showEditDialog(NhomSanPham nhomSanPham) {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.activity_sua_nhom_san_pham, null);
    ...
    private void openDrawableImagePicker(ImageView imgnsp) {
        ...
        builder.setItems(imageNames, (dialog, which) -> {
            ...
            @SuppressLint("DiscouragedApi") int resourceId = context.getResources().getIdentifier(selectedImageName, "drawable", context.getPackageName());
