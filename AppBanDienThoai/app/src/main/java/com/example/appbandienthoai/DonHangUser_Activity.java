    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (order != null) {
                ...
                Toast.makeText(DonHangUser_Activity.this, "ID đơn hàng: " + order.getId(), Toast.LENGTH_SHORT).show();

                // Gửi thông tin đơn hàng qua Intent
                Intent intent = new Intent(DonHangUser_Activity.this, ChiTietDonHang_Activity.class);
