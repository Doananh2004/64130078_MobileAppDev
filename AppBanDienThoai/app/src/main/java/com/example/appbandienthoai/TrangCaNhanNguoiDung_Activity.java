...
public class TrangCaNhanNguoiDung_Activity extends AppCompatActivity {
    String tendn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tendn != null) {
            ...
            Intent intent = new Intent(TrangCaNhanNguoiDung_Activity.this, Login_Activity.class);
        ...
        btncanhan.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), DonHangUser_Activity.class);
            intent.putExtra("tendn", tendn);  // Truyền tendn qua Intent
            startActivity(intent);
        });
        ...
        dangxuat.setOnClickListener(v -> new AlertDialog.Builder(TrangCaNhanNguoiDung_Activity.this)
                .setTitle("Đăng Xuất")
